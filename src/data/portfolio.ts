...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'A modern bakery web application where customers can browse homemade cakes, brownies, and desserts, then place orders seamlessly through WhatsApp and UPI payments. Features product management, order tracking, and an attractive dessert showcase.',
